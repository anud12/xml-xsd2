...
namespace GdUnit4.Examples.Basics.Setup.Test.Stage_8.Autonomy.CallAction;

[TestSuite]
public partial class TestClass : Steps {
    [TestCategory("Stage_8")]
    [TestCase]
    public void Given_autonomy_module_it_should_call_action_when_triggered() {
        AddFileToArchive("module/index.js", "index.js")
            .AddFileToArchive("module/manifest.json", "manifest.json")
            .EnsureDllAccessible()
            .ProcessArchive();

        // Extraction: the runtime must have extracted the autonomy
        // definition from the module source and recorded the attachment.
        AssertRuntimeOutputContains("autonomy registered: guard-behavior");
        AssertRuntimeOutputContains("autonomy attached: guard -> guard-behavior");
