...
namespace GdUnit4.Examples.Basics.Setup.Test.Stage_2.Content.ConstantTextContent.CenterLeft;
...
public class TestClass : Steps {
    ...
    public async Task Given_panel_it_should_have_content_with_full_align() {
        ...
        scene.AssertPanelThat("center-left")
            .IsNonNull()
            .HasContentText("center-left");
