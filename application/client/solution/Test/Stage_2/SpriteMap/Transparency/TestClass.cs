...
namespace GdUnit4.Examples.Basics.Setup.Test.Stage_2.SpriteMap.Transparency;
...
public partial class TestClass : Steps {
    ...
    [TestCase]
    [RequireGodotRuntime]
    public async Task Given_panel_with_transparent_spriteMapTIFF_it_should_compose_with_mask_alpha() {
        try {
